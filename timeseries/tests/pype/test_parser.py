...
def test_example1(filename1 = './timeseries/tests/pype/test_cases/example1.ppl', outputfile1 = './timeseries/tests/pype/test_cases/example1.ast'):
...
def test_example2(filename2 = './timeseries/tests/pype/test_cases/example0.ppl', outputfile2 = './timeseries/tests/pype/test_cases/example0.ast'):
