...
_lr_goto_items = {'parameter_list':([20,21,24,25,26,],[30,31,38,40,41,]),'declaration_list':([22,27,],[35,43,]),'expression_list':([7,],[11,]),'declaration':([22,27,35,43,],[33,33,47,47,]),'expression':([7,11,20,21,24,25,26,30,31,37,38,40,41,],[15,19,29,29,29,29,29,44,44,51,44,44,44,]),'type':([36,],[50,]),'component':([0,3,],[2,8,]),'statement_list':([0,],[3,]),'program':([0,],[4,]),'import_statement':([0,3,],[5,9,]),}
