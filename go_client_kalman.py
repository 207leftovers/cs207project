...
async def main():
    ...
    await client.add_trigger('KalmanFilter', 'insert_ts', ['sig_epsilon_estimate', 'sig_eta_estimate', 'prediction'], None)
    ...
    await client.insert_ts('one',ts.TimeSeries(np.arange(2000),y))
